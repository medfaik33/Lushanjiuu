...
export const TeaLeafIcon: React.FC<IconProps> = ({ className }) => (
  <svg className={className} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10c.85 0 1.67-.11 2.44-.31-.3-.5-.52-1.06-.64-1.66C13.01 18.9 12 16.58 12 14c0-2.21.9-4.21 2.34-5.66C13.21 8.09 12.21 8 12 8c-2.21 0-4 1.79-4 4s1.79 4 4 4c.3 0 .59-.04.87-.1C12.6 17.11 12.32 18 12 18c-3.31 0-6-2.69-6-6s2.69-6 6-6 6 2.69 6 6c0 1.29-.4 2.48-1.08 3.47.88.24 1.81.93 2.51 1.83C20.96 16.32 22 14.28 22 12c0-5.52-4.48-10-10-10zM12 6c-3.31 0-6 2.69-6 6s2.69 6 6 6 6-2.69 6-6-2.69-6-6-6z" />
    <path d="M19.3 14.88C18.6 13.98 17.67 13.29 16.79 13.05 17.52 11.99 18 10.77 18 9.5c0-2.48-2.02-4.5-4.5-4.5S9 7.02 9 9.5c0 .44.06.87.18 1.28-1.1.7-1.97 1.76-2.49 2.98C6.26 14.8 6 15.88 6 17c0 2.21 1.79 4 4 4h.43c.18-.75.46-1.45.82-2.06.35-.6.8-1.11 1.32-1.54.91-.75 2.04-1.25 3.23-1.41.13-.02.26-.03.4-.03.74 0 1.45.15 2.1.42z" />
  </svg>
);
